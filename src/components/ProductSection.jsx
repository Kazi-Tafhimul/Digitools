        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {productData.map((product) => {
            ...
            return (
              <div
                key={product.id}
                className="card bg-base-100 border border-gray-100 shadow-sm rounded-2xl p-6 relative flex flex-col justify-between hover:shadow-md transition-shadow"
              >
                <div className="flex justify-between items-start mb-4">
                  ...
                  <span
                    className={`badge border-none text-xs font-semibold px-2.5 py-1 rounded-full 
